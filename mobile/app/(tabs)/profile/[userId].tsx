      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={styles.profileInfo}>
            <Image
              source={user.profilePicture || require("@/assets/images/default-profile.jpg")}
            ...
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statsRow}>
                <View style={styles.stat}>
                  <Text style={styles.statNumber}>{formatNumber(user.followers_count)}</Text>
                  <Text style={styles.statLabel}>followers</Text>
                </View>
                <View style={styles.stat}>
                  <Text style={styles.statNumber}>{formatNumber(user.likes_count || 0)}</Text>
              ...
              <View style={styles.statsRow}>
                <View style={styles.stat}>
                  <Text style={styles.statNumber}>{formatNumber(user.following_count)}</Text>
                  <Text style={styles.statLabel}>following</Text>
                </View>
                <View style={styles.stat}>
                  <Text style={styles.statNumber}>{formatNumber(user.saves_count || 0)}</Text>
